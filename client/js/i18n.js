const xarcanoid_i18n = {
    ...
    strings: {
        ru: {
            ...
            ach_hidden: "???",
            ach_percent_none: "Ещё никто не получил.",
            ach_percent: "{percent}% игроков ({holders} из {players})",
            ach_no_try_title: "Ты даже не пытался",
            ach_no_try_desc: "Проиграть с нулевым комбо",
            ach_no_try_comment: "Как ты это вообще сделал?",
            ach_finale_title: "Финал",
            ach_finale_desc: "Завершить игру",
            ach_finale_comment: "Финал ведь?",
            ach_true_finale_title: "Истинный Финал",
            ach_true_finale_desc: "Пройти игру на сложности Разгон",
            ach_true_finale_comment: "Альтернативной концовки не будет",
            ach_cheats_title: "Читы",
            ach_cheats_desc: "Воспользоваться помощью дРУгА",
            ach_cheats_comment: "Это дебаг фича, она не для тебя",
            ach_platinum_title: "Платина",
            ach_platinum_desc: "Получить все достижения",
            ach_platinum_comment: "Будем считать, что ты прошёл игру",
            ach_combo20_title: "К-к-комбо!",
            ach_combo20_desc: "Набить комбо 20",
            ach_score100k_title: "Соточка",
            ach_score100k_desc: "Набить больше 100К очков",
            ach_survival30_title: "Снова, и снова, и снова...",
            ach_survival30_desc: "Пройти 30 уровней в выживании",
            ach_two_cores_title: "Опять ты?",
            ach_two_cores_desc: "Победить два Ядра в одном забеге",
            ach_madness_title: "Безумие",
            ach_madness_desc: "Проиграть пять раз подряд в кампании",
            ach_madness_comment: "Точное повторение одного и того же действия...",
            ach_new_player_title: "Новый игрок",
            ach_new_player_desc: "Зарегистрироваться",
            ach_new_player_comment: "Добро пожаловать, наверное...",
            ach_all_drops_title: "Все собрал",
            ach_all_drops_desc: "Получить все виды бонусов",
            ach_all_drops_comment: "Какой ценой?",
            ach_designer_title: "Геймдизайнер",
            ach_designer_desc: "Создать и пройти свой уровень",
            ach_designer_comment: "Достаточно гибкий редактор?",
            ach_focus_title: "Концентрация",
            ach_focus_desc: "Выключить звук и музыку",
            ach_focus_comment: "...",
            ach_guide_title: "Подготовка",
            ach_guide_desc: "Открыть гайд",
            ach_guide_comment: "Часто действительно помогает",
            ach_theme_title: "Мне так больше нравится",
            ach_theme_desc: "Сменить тему игры",
            ach_theme_comment: "Так точно лучше?",
            ach_board_off_title: "Комплексы",
            ach_board_off_desc: "Отключить лидерборд",
            ach_board_off_comment: "Я твои результаты все равно вижу",
        },
        en: {
            player: "Player",
            ...
            ach_hidden: "???",
            ach_percent_none: "Nobody has this yet.",
            ach_percent: "{percent}% of players ({holders} of {players})",
            ach_no_try_title: "You didn't even try",
            ach_no_try_desc: "Lose with a zero combo",
            ach_no_try_comment: "How did you even do that?",
            ach_finale_title: "Finale",
            ach_finale_desc: "Finish the game",
            ach_finale_comment: "That was the finale, right?",
            ach_true_finale_title: "True Finale",
            ach_true_finale_desc: "Clear the game on Overdrive",
            ach_true_finale_comment: "There will be no alternate ending",
            ach_cheats_title: "Cheats",
            ach_cheats_desc: "Use a fRiEND's help",
            ach_cheats_comment: "This is a debug feature. It is not for you.",
            ach_platinum_title: "Platinum",
            ach_platinum_desc: "Unlock every achievement",
            ach_platinum_comment: "We'll say you finished the game",
            ach_combo20_title: "C-c-combo!",
            ach_combo20_desc: "Reach a combo of 20",
            ach_score100k_title: "Hundred grand",
            ach_score100k_desc: "Score more than 100K points",
            ach_survival30_title: "Again, and again, and again...",
            ach_survival30_desc: "Clear 30 stages in Survival",
            ach_two_cores_title: "You again?",
            ach_two_cores_desc: "Defeat two Cores in one run",
            ach_madness_title: "Madness",
            ach_madness_desc: "Lose five campaign runs in a row",
            ach_madness_comment: "The exact same action, over and over...",
            ach_new_player_title: "New player",
            ach_new_player_desc: "Register an account",
            ach_new_player_comment: "Welcome, probably...",
            ach_all_drops_title: "Got them all",
            ach_all_drops_desc: "Collect every kind of power-up",
            ach_all_drops_comment: "At what cost?",
            ach_designer_title: "Game designer",
            ach_designer_desc: "Build and clear your own stage",
            ach_designer_comment: "Flexible enough editor?",
            ach_focus_title: "Focus",
            ach_focus_desc: "Turn off both music and sound",
            ach_focus_comment: "...",
            ach_guide_title: "Preparation",
            ach_guide_desc: "Open the guide",
            ach_guide_comment: "It often actually helps",
            ach_theme_title: "I like it better this way",
            ach_theme_desc: "Change the visual theme",
            ach_theme_comment: "Definitely better, right?",
            ach_board_off_title: "Complexes",
            ach_board_off_desc: "Hide the leaderboard",
            ach_board_off_comment: "I still see your scores",
        },
    },
