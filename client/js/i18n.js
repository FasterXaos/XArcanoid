const xarcanoid_i18n = {
    ...
    strings: {
        ru: {
            ...
            guide_extra: "Из разбитых кирпичей с шансом, зависящим от сложности, падают бонусы: W шире, N уже, S медленнее, F быстрее, + жизнь, C липкая каретка, $ очки. Тренировка сыпет чаще и добрее, Разгон — реже и злее. Ширина и липкость держатся 10 с. Темы и громкость — в шестерёнке. Звук синтезируется в браузере; он может молчать до первого клика. Гость может играть, но рекорд не сохранится.",
        ...
        en: {
            ...
            guide_extra: "Broken bricks may drop power-ups; chance and mix depend on difficulty: W wider, N thinner, S slower, F faster, + life, C sticky paddle, $ points. Practice drops more and kinder, Overdrive fewer and meaner. Width and sticky last 10 s. Themes and volume live in the gear menu. Audio is synthesized in the browser; it may stay silent until the first click. Guests can play, but scores are not saved.",
